...
namespace ServerLib.Json
{
    ...
    public partial class ItemProps
    {
        ...
        public long? QuestStashMaxCount { get; set; }
        ...
        public CantRemoveFromSlotsDuringRaid[] CantRemoveFromSlotsDuringRaid { get; set; }
        ...
        [JsonProperty("LinkedWeapon", NullValueHandling = NullValueHandling.Ignore)]
        public string LinkedWeapon { get; set; }

        [JsonProperty("UseAmmoWithoutShell", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("NoFiremodeOnBoltcatch", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("RepairStrategyTypes", NullValueHandling = NullValueHandling.Ignore)]
        public string[] RepairStrategyTypes { get; set; }
        ...
        [JsonProperty("RemoveShellAfterFire", NullValueHandling = NullValueHandling.Ignore)]
    ...
    public partial class EffectsHealthClass
    {
    ...
    public enum ArmorType { Heavy, Light, None };
    ...
    public enum CantRemoveFromSlotsDuringRaid { Pockets, SecuredContainer };
    ...
    public enum FragmentType { The5485A8684Bdc2Da71D8B4567, The5996F6Cb86F774678763A6Ca, The5996F6D686F77467977Ba6Cc, The5996F6Fc86F7745E585B4De3, The63B35F281745Dd52341E5Da7 };
    ...
    public enum UnlootableFromSlot { ArmBand, FirstPrimaryWeapon, Holster, Pockets, Scabbard, SpecialSlot };
    ...
    {
        public object[] AnythingArray;
        public EffectsHealthClass EffectsHealthClass;
        ...
        public static implicit operator EffectsHealthUnion(EffectsHealthClass EffectsHealthClass) => new EffectsHealthUnion { EffectsHealthClass = EffectsHealthClass };
    }
    ...
    public static class Serialize
    {
        ...
        public static string ToPrettyJson(this System.Collections.Generic.Dictionary<string, ItemBase> self) => JsonConvert.SerializeObject(self, Formatting.Indented, Converter.Settings);
    }
    ...
    internal static class Converter
    {
        public static readonly JsonSerializerSettings Settings = new JsonSerializerSettings
        {
            ...
            Converters =
            {
                ...
                CantRemoveFromSlotsDuringRaidConverter.Singleton,
    ...
    internal class CantRemoveFromSlotsDuringRaidConverter : JsonConverter
    {
        public override bool CanConvert(Type t) => t == typeof(CantRemoveFromSlotsDuringRaid) || t == typeof(CantRemoveFromSlotsDuringRaid?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case "Pockets":
                    return CantRemoveFromSlotsDuringRaid.Pockets;
                case "SecuredContainer":
                    return CantRemoveFromSlotsDuringRaid.SecuredContainer;
            }
            throw new Exception("Cannot unmarshal type CantRemoveFromSlotsDuringRaid");
        }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            var value = (CantRemoveFromSlotsDuringRaid)untypedValue;
            switch (value)
            {
                case CantRemoveFromSlotsDuringRaid.Pockets:
                    serializer.Serialize(writer, "Pockets");
                    return;
                case CantRemoveFromSlotsDuringRaid.SecuredContainer:
                    serializer.Serialize(writer, "SecuredContainer");
                    return;
            }
            throw new Exception("Cannot marshal type CantRemoveFromSlotsDuringRaid");
        }

        public static readonly CantRemoveFromSlotsDuringRaidConverter Singleton = new CantRemoveFromSlotsDuringRaidConverter();
    }
    ...
    internal class CustomAimPlaneConverter : JsonConverter
    {
        ...
        public static readonly CustomAimPlaneConverter Singleton = new CustomAimPlaneConverter();
    }
    ...
    internal class DropSoundTypeConverter : JsonConverter
    {
        ...
        public static readonly DropSoundTypeConverter Singleton = new DropSoundTypeConverter();
    }
    ...
    internal class ExplosionTypeConverter : JsonConverter
    {
        ...
        public static readonly ExplosionTypeConverter Singleton = new ExplosionTypeConverter();
    }
    ...
    internal class FragmentTypeConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                ...
                case "63b35f281745dd52341e5da7":
                    return FragmentType.The63B35F281745Dd52341E5Da7;
            }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                ...
                case FragmentType.The5996F6Fc86F7745E585B4De3:
                    ...
                    return;
                case FragmentType.The63B35F281745Dd52341E5Da7:
                    serializer.Serialize(writer, "63b35f281745dd52341e5da7");
                    return;
            }
            throw new Exception("Cannot marshal type FragmentType");
        }

        public static readonly FragmentTypeConverter Singleton = new FragmentTypeConverter();
    }
    ...
    internal class ItemSoundConverter : JsonConverter
    {
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                ...
                case ItemSound.AmmoSingleround:
                    ...
                    return;
                case ItemSound.Bigknife:
                    serializer.Serialize(writer, "bigknife");
                    return;
        ...
        public static readonly ItemSoundConverter Singleton = new ItemSoundConverter();
    }
    ...
    internal class ModesCountConverter : JsonConverter
    {
        ...
        public static readonly ModesCountConverter Singleton = new ModesCountConverter();
    }
    ...
    internal class SearchSoundConverter : JsonConverter
    {
        ...
        public static readonly SearchSoundConverter Singleton = new SearchSoundConverter();
    }
    ...
    internal class ThrowTypeConverter : JsonConverter
    {
        ...
        public static readonly ThrowTypeConverter Singleton = new ThrowTypeConverter();
    }
    ...
    internal class UnlootableFromSlotConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                ...
                case "Pockets":
                    return UnlootableFromSlot.Pockets;
                case "Scabbard":
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                ...
                case UnlootableFromSlot.Holster:
                    ...
                    return;
                case UnlootableFromSlot.Pockets:
                    serializer.Serialize(writer, "Pockets");
                    return;
    ...
    internal class VisibleAmmoRangesStringConverter : JsonConverter
    {
        ...
        public static readonly VisibleAmmoRangesStringConverter Singleton = new VisibleAmmoRangesStringConverter();
    }
    ...
    internal class EffectsDamageUnionConverter : JsonConverter
    {
        ...
        public static readonly EffectsDamageUnionConverter Singleton = new EffectsDamageUnionConverter();
    }
    ...
    internal class EffectsHealthUnionConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                case JsonToken.StartObject:
                    var objectValue = serializer.Deserialize<EffectsHealthClass>(reader);

namespace ServerLib.Utilities.Helpers
{
    public class CRCHelper
    {
        /*
            ...
            Lookup and compute from here: https://github.com/MerijnHendriks/eft-tech-research/blob/main/Haru/Hashing/Crc32.cs
        ...
        public static Dictionary<string, uint> URL_CRC = new();

        public static bool CheckIfCRCMatch(string url, uint crc)
        {
            if (URL_CRC.TryGetValue(url, out var hash))
            {
                if (crc == hash)
                {
                    return true;

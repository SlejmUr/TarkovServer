...
namespace ServerLib.Handlers
{
    public class ArgumentHandler
    {
        ...
        public static bool FullDebug { get; internal set; } = false;
        public static bool Timer { get; internal set; } = false;
        ...
        public static void MainArg(string[] args)
        {
            ...
            AskHelp = HasParameter(args, "-help") || HasParameter(args, "-h");
            ...
            FullDebug = HasParameter(args, "-fulldebug");
            Timer = HasParameter(args, "-timer");
            if (FullDebug)
            {
                ModdableWebServer.Helper.DebugPrinter.EnableLogs = true;
                ModdableWebServer.Helper.DebugPrinter.PrintToConsole = true;
                Debug = true;
            }
        }
        public static void PrintHelp()
        {
            ...
            Console.WriteLine("-fulldebug \t\t\t Running the server with debug mode (Everything printing to Console)");
            Console.WriteLine("-timer \t\t\t\t Will log how fast is the loading time. (ms)");

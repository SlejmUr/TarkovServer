    ...
    internal class CertHelper
    {
        public static void Make(System.Net.IPAddress serveraddress)
        {
            ...
            if (!Directory.Exists("cert"))
            {
                ...
                MakeCert(serveraddress, "cert/cert.pem", "cert/key.pem");
            }
        ...
        private static void MakeCert(System.Net.IPAddress serveraddress, string certFilename, string keyFilename)
        {
            ...
            var certRequest = new CertificateRequest($"cn={Program.ip_port}", rsa, HashAlgorithmName.SHA256, RSASignaturePadding.Pkcs1);
